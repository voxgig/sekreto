// THE FULL SET: all eleven plugin kinds at once.
//
...
// where taking all eleven is the right answer.
//
...
/// The eleven kinds this library ships as plugins, in the order the design
