...
#
# Missing from it: python, rust, perl, dart and swift, which are waiting
# on an AEAD they can reach within the dependency rule.
MINIVAULT_LANGS="typescript javascript ruby php go java csharp zig kotlin scala clojure elixir cpp c lua ocaml haskell lean"
